...
alias gaacpf='function gaacpff(){ git add .; git commit -m "\$1"; git push --force-with-lease; }; gaacpff'
...
alias gacpf='function gacpff(){ git add "\$1"; git commit -m "\$2"; git push --force-with-lease; }; gacpff'
alias gb='git branch'
...
alias cnt='cargo nextest run --locked --features std --all-targets'
