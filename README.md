...
alias gmom='git merge origin/main --no-edit'
...
# OZ Stylus aliases
alias nitro='$(git rev-parse --show-toplevel)/scripts/nitro-testnode.sh -d -i'
alias e2e='$(git rev-parse --show-toplevel)/scripts/e2e-tests.sh'
alias cnr='cargo nextest run --no-fail-fast'
alias cnrftu='cargo nextest run --features test-utils --no-fail-fast'
...
alias wbash='windsurf ~/.bashrc'
alias wbasha='windsurf ~/.bash_aliases'
alias wprof='windsurf ~/.profile'
...
alias cd4='cd ../../../..'
alias cd5='cd ../../../../..'
alias suup='sudo apt update && sudo apt upgrade -y && sudo apt autoremove -y && rustup update'
EOT
